...
const CLIENTES = [
  { id: 1, nombre: 'Industrias Quispe S.R.L.' },
  { id: 2, nombre: 'Manufactura Torrez' },
];
  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', marginBottom: 12, alignItems: 'center' }}>
        {/*  select con lista hardcodeada de clientes fija *//*}
        <select
          value={form.cliente_id}
          onChange={e => setForm(p => ({ ...p, cliente_id: parseInt(e.target.value) }))}
          style={estiloInput}
        >
      ...
      {msg && (
        <p style={{ fontSize: 13, marginBottom: 12, color: msg.includes('insuficiente') ? '#dc2626' : '#059669' }}>
          {msg}
        </p>
      )}
      <BotonesExportar
